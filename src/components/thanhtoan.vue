                        ...
                        <div class="group-checkout">
                              ...
                              <div class="detail">
                                    <div class="row item">
                                          ...
                                          <div class="col-8 text-end">{{ tt.idT }}</div>
                                    </div>
                                    <div class="row item">
                                          <div class="col-4 fw-bold">Hành trình</div>
                                          <div class="col-8 text-end">{{ tt.tenT }}</div>
                                    </div>
                                    <div class="row item">
                                          <div class="col-4 fw-bold">Ngày đi</div>
                                          <div class="col-8 text-end">{{ formatDate(tt.ngaykhoihanh) }}</div>
                                    </div>
                                    <div class="row item">
                                          <div class="col-4 fw-bold">Ngày về</div>
                                          <div class="col-8 text-end">{{ tt.ngayend }}</div>
                                    </div>
                                    <div class="row item">
                                          <div class="col-4 fw-bold">Nơi khởi hành</div>
                                          <div class="col-8 text-end">{{ tt.noikhoihanh }}</div>
                                    </div>
                              </div>
                              <div class="qr-code">
                                    <div class="image">
