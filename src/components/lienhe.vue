...
<template>
      <div class="container-xxl py-5">
            <div class="container">
                  ...
                  <div class="row g-4">
                        <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s" :key="index"
                              v-for="(tt, index) in lienhe ">
                              <h5>Liên hệ với chúng tôi</h5>
                              <p class="mb-4">Liên hệ với chúng tôi bằng cách sau:</p>
